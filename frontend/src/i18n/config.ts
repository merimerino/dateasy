...
const resources = {
  ...
  hr: {
    translation: {
      ...
      enterRoomName: "Napiši naziv sobe",
      enterPassword: "Napiši lozinku",
      enterUsername: "Napiši svoj nadimak",
      noTasksAvailable: "Nema dostupnih zadataka",
      checkBackLater: "Provjerite kasnije za nove zadatke",
      enterText: "Napiši svoj odgovor",
      answers: "Odgovori",
      characters: "znakova",
      numberBetween: "Napiši broj između",
      and: "i",
      ...
      invalidNumber: "Napiši važeći broj",
      answerLocations: "Oznake na karti ({{count}} odgovora)",
      user: "Korisnik",
      latitude: "Dužina",
      longitude: "Širina",
      coordinate: "Koordinata",
      pieDistribution: "Kružni graf",
      barDistribution: "Stupčasti graf",
      ...
      distributionOfAnswers: "Raspodjela odgovora",
